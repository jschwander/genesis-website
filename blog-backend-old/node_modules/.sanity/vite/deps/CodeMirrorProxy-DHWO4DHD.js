...
} from "./chunk-5LUGH3AG.js";
import "./chunk-RXETEPMY.js";
...
var defaultCodeModes = [
  {
    name: "groq",
    loader: () => import("./dist-JOOUA3YW.js").then(({ javascriptLanguage }) => javascriptLanguage)
  },
  {
    name: "javascript",
    loader: () => import("./dist-JOOUA3YW.js").then(({ javascript }) => javascript({ jsx: false }))
  },
  {
    name: "jsx",
    loader: () => import("./dist-JOOUA3YW.js").then(({ javascript }) => javascript({ jsx: true }))
  },
  {
    name: "typescript",
    loader: () => import("./dist-JOOUA3YW.js").then(
  ...
  { name: "php", loader: () => import("./dist-T6TYCBOR.js").then(({ php }) => php()) },
  { name: "sql", loader: () => import("./dist-JYPW2YNO.js").then(({ sql }) => sql()) },
  {
    name: "mysql",
    loader: () => import("./dist-JYPW2YNO.js").then(({ sql, MySQL }) => sql({ dialect: MySQL }))
  },
  { name: "json", loader: () => import("./dist-PUFRXZRD.js").then(({ json }) => json()) },
  {
    name: "markdown",
    loader: () => import("./dist-CJJOG2XM.js").then(({ markdown }) => markdown())
  },
  { name: "java", loader: () => import("./dist-TXRKYIS5.js").then(({ java }) => java()) },
  { name: "html", loader: () => import("./dist-KUEPQAPW.js").then(({ html }) => html()) },
  {
    name: "csharp",
...
//# sourceMappingURL=CodeMirrorProxy-DHWO4DHD.js.map
