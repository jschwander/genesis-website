...
var ColorList = (0, import_react49.memo)(function({ colors, onChange }) {
...
var ColorPickerFields = ({
  ...
  var _a;
  const { sanity } = useTheme(), inputStyles = (0, import_react49.useMemo)(
    () => ({
      input: {
        width: "80%",
        padding: "4px 10% 3px",
    ...
    [sanity]
  ), handleChange = (0, import_react49.useCallback)(
    (data) => {
...
function ColorInput(props) {
  var _a, _b;
  const { onChange, readOnly } = props, value = props.value, type = props.schemaType, focusRef = (0, import_react49.useRef)(null), [color, setColor] = (0, import_react49.useState)(value);
  (0, import_react49.useEffect)(() => (0, import_react49.startTransition)(() => setColor(value)), [value]);
  const [emitColor, setEmitColor] = (0, import_react49.useState)(void 0), debouncedColor = (0, import_react49.useDeferredValue)(emitColor), handleChange = useEffectEvent((nextColor) => {
    var _a2;
  ...
  }, []), handleColorChange = (0, import_react49.useCallback)((nextColor) => {
    setColor(nextColor), setEmitColor(nextColor);
  }, []), handleUnset = (0, import_react49.useCallback)(() => {
...
//# sourceMappingURL=ColorInput-557YECTM.js.map
