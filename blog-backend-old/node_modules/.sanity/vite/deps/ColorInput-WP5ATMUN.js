    ...
    (function(global2, factory) {
      ...
      tinycolor3.prototype = {
        ...
        setAlpha: function setAlpha2(value) {
          this._a = boundAlpha3(value);
          this._roundA = Math.round(100 * this._a) / 100;
          return this;
        },
        toHsv: function toHsv2() {
          var hsv = rgbToHsv3(this._r, this._g, this._b);
          return {
            h: hsv.h * 360,
            s: hsv.s,
            v: hsv.v,
        ...
        toHsl: function toHsl2() {
          var hsl = rgbToHsl3(this._r, this._g, this._b);
          return {
            h: hsl.h * 360,
            s: hsl.s,
            l: hsl.l,
        ...
        toHex: function toHex2(allow3Char) {
          return rgbToHex3(this._r, this._g, this._b, allow3Char);
        },
        toHexString: function toHexString2(allow3Char) {
          return "#" + this.toHex(allow3Char);
        },
        toHex8: function toHex82(allow4Char) {
          return rgbaToHex3(this._r, this._g, this._b, this._a, allow4Char);
        },
        ...
        toPercentageRgb: function toPercentageRgb2() {
          return {
            r: Math.round(bound013(this._r, 255) * 100) + "%",
            g: Math.round(bound013(this._g, 255) * 100) + "%",
            b: Math.round(bound013(this._b, 255) * 100) + "%",
            a: this._a
          };
        },
        toPercentageRgbString: function toPercentageRgbString2() {
          return this._a == 1 ? "rgb(" + Math.round(bound013(this._r, 255) * 100) + "%, " + Math.round(bound013(this._g, 255) * 100) + "%, " + Math.round(bound013(this._b, 255) * 100) + "%)" : "rgba(" + Math.round(bound013(this._r, 255) * 100) + "%, " + Math.round(bound013(this._g, 255) * 100) + "%, " + Math.round(bound013(this._b, 255) * 100) + "%, " + this._roundA + ")";
        },
        toName: function toName2() {
          ...
          return hexNames3[rgbToHex3(this._r, this._g, this._b, true)] || false;
        },
        toFilter: function toFilter2(secondColor) {
          var hex8String = "#" + rgbaToArgbHex3(this._r, this._g, this._b, this._a);
          var secondHex8String = hex8String;
          var gradientType = this._gradientType ? "GradientType = 1, " : "";
          if (secondColor) {
            var s = tinycolor3(secondColor);
            secondHex8String = "#" + rgbaToArgbHex3(s._r, s._g, s._b, s._a);
          }
        ...
        lighten: function lighten2() {
          return this._applyModification(_lighten3, arguments);
        },
        brighten: function brighten2() {
          return this._applyModification(_brighten3, arguments);
        },
        darken: function darken2() {
          return this._applyModification(_darken3, arguments);
        },
        desaturate: function desaturate2() {
          return this._applyModification(_desaturate3, arguments);
        },
        saturate: function saturate2() {
          return this._applyModification(_saturate3, arguments);
        },
        greyscale: function greyscale2() {
          return this._applyModification(_greyscale3, arguments);
        },
        spin: function spin2() {
          return this._applyModification(_spin3, arguments);
        },
        _applyCombination: function _applyCombination2(fn, args) {
          return fn.apply(null, [this].concat([].slice.call(args)));
        },
        analogous: function analogous2() {
          return this._applyCombination(_analogous3, arguments);
        },
        complement: function complement2() {
          return this._applyCombination(_complement3, arguments);
        },
        monochromatic: function monochromatic2() {
          return this._applyCombination(_monochromatic3, arguments);
        },
        splitcomplement: function splitcomplement2() {
          return this._applyCombination(_splitcomplement3, arguments);
        },
        ...
        triad: function triad2() {
          return this._applyCombination(polyad3, [3]);
        },
        tetrad: function tetrad2() {
          return this._applyCombination(polyad3, [4]);
        }
      };
          ...
          for (var i in color) {
            if (color.hasOwnProperty(i)) {
              if (i === "a") {
                ...
                newColor[i] = convertToPercentage3(color[i]);
              }
            }
          }
          color = newColor;
      ...
      function inputToRGB3(color) {
        ...
        if (typeof color == "string") {
          color = stringInputToObject3(color);
        }
        if (_typeof3(color) == "object") {
          if (isValidCSSUnit3(color.r) && isValidCSSUnit3(color.g) && isValidCSSUnit3(color.b)) {
            rgb = rgbToRgb3(color.r, color.g, color.b);
            ok = true;
            format = String(color.r).substr(-1) === "%" ? "prgb" : "rgb";
          } else if (isValidCSSUnit3(color.h) && isValidCSSUnit3(color.s) && isValidCSSUnit3(color.v)) {
            s = convertToPercentage3(color.s);
            v = convertToPercentage3(color.v);
            rgb = hsvToRgb3(color.h, s, v);
            ok = true;
            format = "hsv";
          } else if (isValidCSSUnit3(color.h) && isValidCSSUnit3(color.s) && isValidCSSUnit3(color.l)) {
            s = convertToPercentage3(color.s);
            l = convertToPercentage3(color.l);
            rgb = hslToRgb3(color.h, s, l);
            ok = true;
            format = "hsl";
          }
      ...
      function rgbToRgb3(r, g, b) {
        return {
          r: bound013(r, 255) * 255,
          g: bound013(g, 255) * 255,
          b: bound013(b, 255) * 255
        };
      }
      ...
      function rgbToHex3(r, g, b, allow3Char) {
        var hex = [pad23(Math.round(r).toString(16)), pad23(Math.round(g).toString(16)), pad23(Math.round(b).toString(16))];
        if (allow3Char && hex[0].charAt(0) == hex[0].charAt(1) && hex[1].charAt(0) == hex[1].charAt(1) && hex[2].charAt(0) == hex[2].charAt(1)) {
          return hex[0].charAt(0) + hex[1].charAt(0) + hex[2].charAt(0);
        }
        return hex.join("");
      }
      function rgbaToHex3(r, g, b, a, allow4Char) {
        var hex = [pad23(Math.round(r).toString(16)), pad23(Math.round(g).toString(16)), pad23(Math.round(b).toString(16)), pad23(convertDecimalToHex3(a))];
        if (allow4Char && hex[0].charAt(0) == hex[0].charAt(1) && hex[1].charAt(0) == hex[1].charAt(1) && hex[2].charAt(0) == hex[2].charAt(1) && hex[3].charAt(0) == hex[3].charAt(1)) {
          return hex[0].charAt(0) + hex[1].charAt(0) + hex[2].charAt(0) + hex[3].charAt(0);
        }
        return hex.join("");
      }
      function rgbaToArgbHex3(r, g, b, a) {
        var hex = [pad23(convertDecimalToHex3(a)), pad23(Math.round(r).toString(16)), pad23(Math.round(g).toString(16)), pad23(Math.round(b).toString(16))];
        return hex.join("");
      }
      ...
      function _desaturate3(color, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor3(color).toHsl();
        hsl.s -= amount / 100;
        hsl.s = clamp013(hsl.s);
        return tinycolor3(hsl);
      }
      function _saturate3(color, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor3(color).toHsl();
        hsl.s += amount / 100;
        hsl.s = clamp013(hsl.s);
      ...
      function _greyscale3(color) {
        return tinycolor3(color).desaturate(100);
      }
      function _lighten3(color, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor3(color).toHsl();
        hsl.l += amount / 100;
        hsl.l = clamp013(hsl.l);
        return tinycolor3(hsl);
      }
      function _brighten3(color, amount) {
        amount = amount === 0 ? 0 : amount || 10;
      ...
      function _darken3(color, amount) {
        amount = amount === 0 ? 0 : amount || 10;
        var hsl = tinycolor3(color).toHsl();
        hsl.l -= amount / 100;
        hsl.l = clamp013(hsl.l);
      ...
      function _spin3(color, amount) {
        var hsl = tinycolor3(color).toHsl();
        var hue = (hsl.h + amount) % 360;
        hsl.h = hue < 0 ? 360 + hue : hue;
        return tinycolor3(hsl);
      }
      function _complement3(color) {
        var hsl = tinycolor3(color).toHsl();
        hsl.h = (hsl.h + 180) % 360;
        return tinycolor3(hsl);
      }
      function polyad3(color, number) {
        if (isNaN(number) || number <= 0) {
          throw new Error("Argument to polyad must be a positive number");
        }
        var hsl = tinycolor3(color).toHsl();
        var result = [tinycolor3(color)];
        var step = 360 / number;
        for (var i = 1; i < number; i++) {
          result.push(tinycolor3({
            h: (hsl.h + i * step) % 360,
            s: hsl.s,
            l: hsl.l
          }));
      ...
      function _splitcomplement3(color) {
        var hsl = tinycolor3(color).toHsl();
        var h = hsl.h;
        return [tinycolor3(color), tinycolor3({
          h: (h + 72) % 360,
          s: hsl.s,
          l: hsl.l
        }), tinycolor3({
      ...
      function _analogous3(color, results, slices) {
        results = results || 6;
        slices = slices || 30;
        var hsl = tinycolor3(color).toHsl();
        var part = 360 / slices;
      ...
      function _monochromatic3(color, results) {
        results = results || 6;
      ...
      tinycolor3.isReadable = function(color1, color2, wcag2) {
        ...
        var wcag2Parms, out;
        out = false;
        wcag2Parms = validateWCAG2Parms3(wcag2);
      ...
      tinycolor3.mostReadable = function(baseColor, colorList, args) {
        ...
        if (tinycolor3.isReadable(baseColor, bestColor, {
          level,
          size
      ...
      var hexNames3 = tinycolor3.hexNames = flip3(names3);
      function flip3(o) {
        var flipped = {};
        for (var i in o) {
      ...
      function bound013(n, max) {
        if (isOnePointZero3(n)) n = "100%";
        var processPercent = isPercentage3(n);
      ...
      function clamp013(val) {
        return Math.min(1, Math.max(0, val));
      }
      function parseIntFromHex3(val) {
        return parseInt(val, 16);
      }
      function isOnePointZero3(n) {
        return typeof n == "string" && n.indexOf(".") != -1 && parseFloat(n) === 1;
      }
      function isPercentage3(n) {
        return typeof n === "string" && n.indexOf("%") != -1;
      }
      function pad23(c) {
        return c.length == 1 ? "0" + c : "" + c;
      }
      function convertToPercentage3(n) {
        if (n <= 1) {
          n = n * 100 + "%";
        }
        return n;
      }
      function convertDecimalToHex3(d) {
        return Math.round(parseFloat(d) * 255).toString(16);
      }
      function convertHexToDecimal3(h) {
        return parseIntFromHex3(h) / 255;
      }
      var matchers3 = function() {
        var CSS_INTEGER = "[-\\+]?\\d+%?";
        var CSS_NUMBER = "[-\\+]?\\d*\\.\\d+%?";
      ...
      function isValidCSSUnit3(color) {
        return !!matchers3.CSS_UNIT.exec(color);
      }
      function stringInputToObject3(color) {
        color = color.replace(trimLeft3, "").replace(trimRight3, "").toLowerCase();
        var named = false;
        if (names3[color]) {
          color = names3[color];
          named = true;
        ...
        var match;
        if (match = matchers3.rgb.exec(color)) {
          return {
            r: match[1],
            g: match[2],
            b: match[3]
        ...
        if (match = matchers3.rgba.exec(color)) {
          return {
            r: match[1],
            g: match[2],
            b: match[3],
        ...
        if (match = matchers3.hsl.exec(color)) {
          return {
            h: match[1],
            s: match[2],
            l: match[3]
        ...
        if (match = matchers3.hsla.exec(color)) {
          return {
            h: match[1],
            s: match[2],
            l: match[3],
        ...
        if (match = matchers3.hsv.exec(color)) {
          return {
            h: match[1],
            s: match[2],
            v: match[3]
        ...
        if (match = matchers3.hsva.exec(color)) {
          return {
            h: match[1],
            s: match[2],
            v: match[3],
        ...
        if (match = matchers3.hex8.exec(color)) {
          return {
            r: parseIntFromHex3(match[1]),
            g: parseIntFromHex3(match[2]),
            b: parseIntFromHex3(match[3]),
            a: convertHexToDecimal3(match[4]),
            format: named ? "name" : "hex8"
          };
        }
        if (match = matchers3.hex6.exec(color)) {
          return {
            r: parseIntFromHex3(match[1]),
            g: parseIntFromHex3(match[2]),
            b: parseIntFromHex3(match[3]),
        ...
        if (match = matchers3.hex4.exec(color)) {
          return {
            r: parseIntFromHex3(match[1] + "" + match[1]),
            g: parseIntFromHex3(match[2] + "" + match[2]),
            b: parseIntFromHex3(match[3] + "" + match[3]),
            a: convertHexToDecimal3(match[4] + "" + match[4]),
            format: named ? "name" : "hex8"
          };
        }
        if (match = matchers3.hex3.exec(color)) {
          return {
            r: parseIntFromHex3(match[1] + "" + match[1]),
            g: parseIntFromHex3(match[2] + "" + match[2]),
            b: parseIntFromHex3(match[3] + "" + match[3]),
      ...
      function validateWCAG2Parms3(parms) {
        var level, size;
        parms = parms || {
          level: "AA",
          size: "small"
  ...
  "node_modules/react-color/lib/components/common/Swatch.js"(exports2) {
    ...
    var Swatch3 = exports2.Swatch = function Swatch4(_ref) {
      ...
      var handleKeyDown = function handleKeyDown2(e) {
        return e.keyCode === ENTER2 && onClick(color, e);
      };
...
// node_modules/@sanity/color-input/lib/_chunks-es/ColorInput.mjs
...
function useEffectEvent(fn) {
  ...
  return (0, import_react.useInsertionEffect)(() => {
    ref.current = fn;
  }, [fn]), (0, import_react.useCallback)((...args) => {
  ...
  return import_react36.default.createElement(
    ...
    colors.map(function(colorObjOrString) {
      ...
      return import_react36.default.createElement(
        ...
        import_react36.default.createElement(Swatch_default, _extends8({}, c, {
          style: styles.swatch,
          onClick: handleClick,
          onHover: onSwatchHover,
          focusStyle: {
...
function tinycolor2(color, opts) {
  if (color = color || "", opts = opts || {}, color instanceof tinycolor2)
    return color;
...
tinycolor2.prototype = {
  ...
  setAlpha: function(value) {
    return this._a = boundAlpha2(value), this._roundA = Math.round(100 * this._a) / 100, this;
  },
  toHsv: function() {
  ...
  toHsvString: function() {
    var hsv = rgbToHsv2(this._r, this._g, this._b), h = Math.round(hsv.h * 360), s = Math.round(hsv.s * 100), v = Math.round(hsv.v * 100);
    return this._a == 1 ? "hsv(" + h + ", " + s + "%, " + v + "%)" : "hsva(" + h + ", " + s + "%, " + v + "%, " + this._roundA + ")";
  },
  toHsl: function() {
  ...
  toHslString: function() {
    var hsl = rgbToHsl2(this._r, this._g, this._b), h = Math.round(hsl.h * 360), s = Math.round(hsl.s * 100), l = Math.round(hsl.l * 100);
    return this._a == 1 ? "hsl(" + h + ", " + s + "%, " + l + "%)" : "hsla(" + h + ", " + s + "%, " + l + "%, " + this._roundA + ")";
  },
  ...
  toName: function() {
    return this._a === 0 ? "transparent" : this._a < 1 ? false : hexNames2[rgbToHex2(this._r, this._g, this._b, true)] || false;
  },
  toFilter: function(secondColor) {
    var hex8String = "#" + rgbaToArgbHex2(this._r, this._g, this._b, this._a), secondHex8String = hex8String, gradientType = this._gradientType ? "GradientType = 1, " : "";
    if (secondColor) {
  ...
  toString: function(format) {
    var formatSet = !!format;
    format = format || this._format;
    var formattedString = false, hasAlpha = this._a < 1 && this._a >= 0, needsAlphaFormat = !formatSet && hasAlpha && (format === "hex" || format === "hex6" || format === "hex3" || format === "hex4" || format === "hex8" || format === "name");
    return needsAlphaFormat ? format === "name" && this._a === 0 ? this.toName() : this.toRgbString() : (format === "rgb" && (formattedString = this.toRgbString()), format === "prgb" && (formattedString = this.toPercentageRgbString()), (format === "hex" || format === "hex6") && (formattedString = this.toHexString()), format === "hex3" && (formattedString = this.toHexString(true)), format === "hex4" && (formattedString = this.toHex8String(true)), format === "hex8" && (formattedString = this.toHex8String()), format === "name" && (formattedString = this.toName()), format === "hsl" && (formattedString = this.toHslString()), format === "hsv" && (formattedString = this.toHsvString()), formattedString || this.toHexString());
  },
  clone: function() {
...
tinycolor2.fromRatio = function(color, opts) {
  if (_typeof2(color) == "object") {
    var newColor = {};
    for (var i in color)
      color.hasOwnProperty(i) && (i === "a" ? newColor[i] = color[i] : newColor[i] = convertToPercentage2(color[i]));
    color = newColor;
  }
...
function inputToRGB2(color) {
  var rgb = {
    ...
    g: 0,
    b: 0
  }, a = 1, s = null, v = null, l = null, ok = false, format = false;
  return typeof color == "string" && (color = stringInputToObject2(color)), _typeof2(color) == "object" && (isValidCSSUnit2(color.r) && isValidCSSUnit2(color.g) && isValidCSSUnit2(color.b) ? (rgb = rgbToRgb2(color.r, color.g, color.b), ok = true, format = String(color.r).substr(-1) === "%" ? "prgb" : "rgb") : isValidCSSUnit2(color.h) && isValidCSSUnit2(color.s) && isValidCSSUnit2(color.v) ? (s = convertToPercentage2(color.s), v = convertToPercentage2(color.v), rgb = hsvToRgb2(color.h, s, v), ok = true, format = "hsv") : isValidCSSUnit2(color.h) && isValidCSSUnit2(color.s) && isValidCSSUnit2(color.l) && (s = convertToPercentage2(color.s), l = convertToPercentage2(color.l), rgb = hslToRgb2(color.h, s, l), ok = true, format = "hsl"), color.hasOwnProperty("a") && (a = color.a)), a = boundAlpha2(a), {
    ok,
    format: color.format || format,
    r: Math.min(255, Math.max(rgb.r, 0)),
    g: Math.min(255, Math.max(rgb.g, 0)),
...
function rgbToHsl2(r, g, b) {
  r = bound012(r, 255), g = bound012(g, 255), b = bound012(b, 255);
...
function hslToRgb2(h, s, l) {
  var r, g, b;
  h = bound012(h, 360), s = bound012(s, 100), l = bound012(l, 100);
  function hue2rgb(p2, q2, t) {
...
function hsvToRgb2(h, s, v) {
  h = bound012(h, 360) * 6, s = bound012(s, 100), v = bound012(v, 100);
  var i = Math.floor(h), f = h - i, p = v * (1 - s), q = v * (1 - f * s), t = v * (1 - (1 - f) * s), mod = i % 6, r = [v, q, p, p, t, v][mod], g = [t, v, v, q, p, p][mod], b = [p, p, t, v, v, q][mod];
  return {
    r: r * 255,
    g: g * 255,
...
tinycolor2.equals = function(color1, color2) {
  return !color1 || !color2 ? false : tinycolor2(color1).toRgbString() == tinycolor2(color2).toRgbString();
};
...
function _desaturate2(color, amount) {
  ...
  return hsl.s -= amount / 100, hsl.s = clamp012(hsl.s), tinycolor2(hsl);
}
...
function _lighten2(color, amount) {
  amount = amount === 0 ? 0 : amount || 10;
  var hsl = tinycolor2(color).toHsl();
  return hsl.l += amount / 100, hsl.l = clamp012(hsl.l), tinycolor2(hsl);
}
function _brighten2(color, amount) {
  amount = amount === 0 ? 0 : amount || 10;
  var rgb = tinycolor2(color).toRgb();
  return rgb.r = Math.max(0, Math.min(255, rgb.r - Math.round(255 * -(amount / 100)))), rgb.g = Math.max(0, Math.min(255, rgb.g - Math.round(255 * -(amount / 100)))), rgb.b = Math.max(0, Math.min(255, rgb.b - Math.round(255 * -(amount / 100)))), tinycolor2(rgb);
}
...
function _spin2(color, amount) {
  var hsl = tinycolor2(color).toHsl(), hue = (hsl.h + amount) % 360;
  return hsl.h = hue < 0 ? 360 + hue : hue, tinycolor2(hsl);
}
function _complement2(color) {
  var hsl = tinycolor2(color).toHsl();
  return hsl.h = (hsl.h + 180) % 360, tinycolor2(hsl);
}
function polyad2(color, number) {
  if (isNaN(number) || number <= 0)
    throw new Error("Argument to polyad must be a positive number");
  for (var hsl = tinycolor2(color).toHsl(), result = [tinycolor2(color)], step = 360 / number, i = 1; i < number; i++)
...
function _splitcomplement2(color) {
  var hsl = tinycolor2(color).toHsl(), h = hsl.h;
...
function _analogous2(color, results, slices) {
  ...
  var hsl = tinycolor2(color).toHsl(), part = 360 / slices, ret = [tinycolor2(color)];
  for (hsl.h = (hsl.h - (part * results >> 1) + 720) % 360; --results; )
    hsl.h = (hsl.h + part) % 360, ret.push(tinycolor2(hsl));
  return ret;
}
function _monochromatic2(color, results) {
  results = results || 6;
  for (var hsv = tinycolor2(color).toHsv(), h = hsv.h, s = hsv.s, v = hsv.v, ret = [], modification = 1 / results; results--; )
    ret.push(tinycolor2({
      h,
      s,
      v
...
tinycolor2.mix = function(color1, color2, amount) {
  amount = amount === 0 ? 0 : amount || 50;
  var rgb1 = tinycolor2(color1).toRgb(), rgb2 = tinycolor2(color2).toRgb(), p = amount / 100, rgba = {
    r: (rgb2.r - rgb1.r) * p + rgb1.r,
    g: (rgb2.g - rgb1.g) * p + rgb1.g,
    b: (rgb2.b - rgb1.b) * p + rgb1.b,
    a: (rgb2.a - rgb1.a) * p + rgb1.a
...
tinycolor2.readability = function(color1, color2) {
  var c1 = tinycolor2(color1), c2 = tinycolor2(color2);
  return (Math.max(c1.getLuminance(), c2.getLuminance()) + 0.05) / (Math.min(c1.getLuminance(), c2.getLuminance()) + 0.05);
};
tinycolor2.isReadable = function(color1, color2, wcag2) {
  var readability = tinycolor2.readability(color1, color2), wcag2Parms, out;
  switch (out = false, wcag2Parms = validateWCAG2Parms2(wcag2), wcag2Parms.level + wcag2Parms.size) {
    case "AAsmall":
    case "AAAlarge":
      out = readability >= 4.5;
      break;
...
tinycolor2.mostReadable = function(baseColor, colorList, args) {
  ...
  for (var i = 0; i < colorList.length; i++)
    readability = tinycolor2.readability(baseColor, colorList[i]), readability > bestScore && (bestScore = readability, bestColor = tinycolor2(colorList[i]));
  return tinycolor2.isReadable(baseColor, bestColor, {
    level,
    size
  }) || !includeFallbackColors ? bestColor : (args.includeFallbackColors = false, tinycolor2.mostReadable(baseColor, ["#fff", "#000"], args));
};
...
function stringInputToObject2(color) {
  ...
  var match;
  return (match = matchers2.rgb.exec(color)) ? {
    r: match[1],
    g: match[2],
    b: match[3]
...
var ColorListWrap = dt(Flex)`
  gap: 0.25em;
`;
var ColorBoxContainer = dt.div`
  width: 2.1em;
  height: 2.1em;
  cursor: pointer;
  position: relative;
...
var ColorBox$1 = dt.div`
  ...
  z-index: 1;
`;
var validateColors = (colors) => colors.reduce((cls, c) => {
  const color = c.hex ? tinycolor2(c.hex) : tinycolor2(c);
  return color.isValid() && cls.push({
    color: c,
    backgroundColor: color.toRgbString()
  }), cls;
}, []);
var ColorList = (0, import_react50.memo)(function({ colors, onChange }) {
  return colors ? (0, import_jsx_runtime.jsx)(ColorListWrap, { wrap: "wrap", children: validateColors(colors).map(({ color, backgroundColor }, idx) => (0, import_jsx_runtime.jsx)(
    ColorBoxContainer,
    {
      onClick: () => {
        onChange(color);
      },
      children: (0, import_jsx_runtime.jsx)(ColorBox$1, { style: { background: backgroundColor } })
    },
    `${backgroundColor}-${idx}`
  )) }) : null;
});
var ColorPickerFields = ({
  onChange,
  rgb,
  hsl,
  hex,
  ...
  var _a;
  const { sanity } = useTheme(), inputStyles = (0, import_react50.useMemo)(
    () => ({
      input: {
        width: "80%",
        padding: "4px 10% 3px",
    ...
    [sanity]
  ), handleChange = (0, import_react50.useCallback)(
    (data) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { children: [
    (0, import_jsx_runtime.jsx)(Box, { flex: 2, marginRight: 1, children: (0, import_jsx_runtime.jsx)(
      import_common26.EditableInput,
      {
        style: inputStyles,
        label: "hex",
    ...
    (0, import_jsx_runtime.jsx)(Box, { flex: 1, marginRight: 1, children: (0, import_jsx_runtime.jsx)(
      import_common26.EditableInput,
      {
        style: inputStyles,
        label: "r",
    ...
    !disableAlpha && (0, import_jsx_runtime.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime.jsx)(
      import_common26.EditableInput,
      {
        style: inputStyles,
        label: "a",
...
var ColorPickerInner = (props) => {
  ...
  return !hsl || !hsv ? null : (0, import_jsx_runtime.jsx)("div", { style: { width }, children: (0, import_jsx_runtime.jsx)(Card, { padding: 1, border: true, radius: 1, children: (0, import_jsx_runtime.jsxs)(Stack, { space: 2, children: [
    !readOnly && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      (0, import_jsx_runtime.jsx)(Card, { overflow: "hidden", style: { position: "relative", height: "5em" }, children: (0, import_jsx_runtime.jsx)(import_common26.Saturation, { onChange, hsl, hsv }) }),
      (0, import_jsx_runtime.jsx)(
        Card,
        {
          ...
          children: (0, import_jsx_runtime.jsx)(import_common26.Hue, { hsl, onChange: !readOnly && onChange })
        }
      ),
      !disableAlpha && (0, import_jsx_runtime.jsx)(
        Card,
        {
          shadow: 1,
          radius: 3,
          ...
          children: (0, import_jsx_runtime.jsx)(import_common26.Alpha, { rgb, hsl, onChange })
        }
      )
    ] }),
    (0, import_jsx_runtime.jsxs)(Flex, { children: [
      (0, import_jsx_runtime.jsxs)(
        Card,
        {
          ...
          children: [
            ...
            readOnly && (0, import_jsx_runtime.jsx)(
              ReadOnlyContainer,
              {
                padding: 2,
                paddingBottom: 1,
                ...
                children: (0, import_jsx_runtime.jsxs)(Stack, { space: 3, marginTop: 1, children: [
                  (0, import_jsx_runtime.jsx)(Text, { size: 3, weight: "bold", children: hex }),
                  (0, import_jsx_runtime.jsxs)(Inline, { space: 3, children: [
                    (0, import_jsx_runtime.jsxs)(Text, { size: 1, children: [
                      (0, import_jsx_runtime.jsx)("strong", { children: "RGB: " }),
                    ...
                    (0, import_jsx_runtime.jsxs)(Text, { size: 1, children: [
                      (0, import_jsx_runtime.jsx)("strong", { children: "HSL: " }),
                      " ",
      ...
      !readOnly && (0, import_jsx_runtime.jsxs)(Flex, { align: "flex-start", marginLeft: 2, children: [
        (0, import_jsx_runtime.jsx)(Box, { style: { width: 200 }, children: (0, import_jsx_runtime.jsx)(
          ColorPickerFields,
          {
            rgb,
            hsl,
        ...
        (0, import_jsx_runtime.jsx)(Box, { marginLeft: 2, children: (0, import_jsx_runtime.jsx)(Button, { onClick: onUnset, title: "Delete color", icon: TrashIcon, tone: "critical" }) })
      ] })
    ] }),
    colorList && (0, import_jsx_runtime.jsx)(ColorList, { colors: colorList, onChange })
  ] }) }) });
};
...
function ColorInput(props) {
  var _a, _b;
  const { onChange, readOnly } = props, value = props.value, type = props.schemaType, focusRef = (0, import_react50.useRef)(null), [color, setColor] = (0, import_react50.useState)(value);
  (0, import_react50.useEffect)(() => (0, import_react50.startTransition)(() => setColor(value)), [value]);
  const [emitColor, setEmitColor] = (0, import_react50.useState)(void 0), debouncedColor = (0, import_react50.useDeferredValue)(emitColor), handleChange = useEffectEvent((nextColor) => {
    var _a2;
    const fieldPatches = type.fields.filter((field) => field.name in nextColor).map((field) => {
      const nextFieldValue = nextColor[field.name], isObject2 = field.type.jsonType === "object";
      return set(
        isObject2 ? Object.assign({ _type: field.type.name }, nextFieldValue) : nextFieldValue,
        [field.name]
      );
    });
    onChange([
      ...
      set(type.name, ["_type"]),
      set((_a2 = nextColor.rgb) == null ? void 0 : _a2.a, ["alpha"]),
      ...fieldPatches
    ]);
  });
  ...
  const handleCreateColor = (0, import_react50.useCallback)(() => {
    setColor(DEFAULT_COLOR), setEmitColor(DEFAULT_COLOR);
  }, []), handleColorChange = (0, import_react50.useCallback)((nextColor) => {
    setColor(nextColor), setEmitColor(nextColor);
  }, []), handleUnset = (0, import_react50.useCallback)(() => {
    setColor(void 0), onChange(unset());
  }, [onChange]);
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: value && value.hex ? (0, import_jsx_runtime.jsx)(
    ColorPicker,
    {
      color,
...
//# sourceMappingURL=ColorInput-WP5ATMUN.js.map
